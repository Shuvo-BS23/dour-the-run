    ...
    <div class="p-grid nested-grid">
      <div class="p-col-3">
        <div class="p-grid">
          ...
          <div class="p-col-12">
            <Card class="card-items">
              <template #content> Hello {{ firstName }} </template>
            </Card>
          </div>
        </div>
      </div>
  ...
  setup() {
    ...
    function goToStrava() {
      window.location.href =
        "https://www.strava.com/oauth/authorize?client_id=75194&response_type=code&redirect_uri=http://localhost:3000/get-strava-code&scope=read_all";
    }

    return { firstName, lastName, proPic, goToStrava };
  },
});
</script>
